...
var ASM_CONSTS = {
 ...
 3631168: () => globalThis.ctrdxCanvas ? 1 : 0,
 3631211: ($0, $1) => {
 ...
 3632108: () => globalThis.ctrdxContextLost | 0
};
...
function ___syscall_fadvise64(fd, offset, len, advice) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(5, 0, 0, fd, offset, len, advice);
 return 0;
}
...
function ___syscall_statfs64(path, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(10, 0, 1, path, size, buf);
 try {
  path = SYSCALLS.getStr(path);
...
function ___syscall_fstatfs64(fd, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(9, 0, 1, fd, size, buf);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
var _environ_get = function(__environ, environ_buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(28, 0, 1, __environ, environ_buf);
 var bufSize = 0;
...
var _environ_sizes_get = function(penviron_count, penviron_buf_size) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(29, 0, 1, penviron_count, penviron_buf_size);
...
function _fd_fdstat_get(fd, pbuf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(31, 0, 1, fd, pbuf);
 try {
  var rightsBase = 0;
...
function _fd_pread(fd, iov, iovcnt, offset, pnum) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(32, 0, 1, fd, iov, iovcnt, offset, pnum);
 offset = bigintToI53Checked(offset);
 try {
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _fd_pwrite(fd, iov, iovcnt, offset, pnum) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(33, 0, 1, fd, iov, iovcnt, offset, pnum);
 offset = bigintToI53Checked(offset);
 try {
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
var _ctrdx_thread_id = Module["_ctrdx_thread_id"] = () => (_ctrdx_thread_id = Module["_ctrdx_thread_id"] = wasmExports["ctrdx_thread_id"])();

var _pthread_self = Module["_pthread_self"] = () => (_pthread_self = Module["_pthread_self"] = wasmExports["pthread_self"])();

var _ctrdx_is_main_runtime_thread = Module["_ctrdx_is_main_runtime_thread"] = () => (_ctrdx_is_main_runtime_thread = Module["_ctrdx_is_main_runtime_thread"] = wasmExports["ctrdx_is_main_runtime_thread"])();

var _ctrdx_set_frame_callback = Module["_ctrdx_set_frame_callback"] = a0 => (_ctrdx_set_frame_callback = Module["_ctrdx_set_frame_callback"] = wasmExports["ctrdx_set_frame_callback"])(a0);

var _ctrdx_frame_entry = Module["_ctrdx_frame_entry"] = a0 => (_ctrdx_frame_entry = Module["_ctrdx_frame_entry"] = wasmExports["ctrdx_frame_entry"])(a0);

var _ctrdx_request_frame = Module["_ctrdx_request_frame"] = () => (_ctrdx_request_frame = Module["_ctrdx_request_frame"] = wasmExports["ctrdx_request_frame"])();

var _ctrdx_install_canvas_listener = Module["_ctrdx_install_canvas_listener"] = () => (_ctrdx_install_canvas_listener = Module["_ctrdx_install_canvas_listener"] = wasmExports["ctrdx_install_canvas_listener"])();

var _ctrdx_canvas_received = Module["_ctrdx_canvas_received"] = () => (_ctrdx_canvas_received = Module["_ctrdx_canvas_received"] = wasmExports["ctrdx_canvas_received"])();

var _ctrdx_create_worker_context = Module["_ctrdx_create_worker_context"] = (a0, a1) => (_ctrdx_create_worker_context = Module["_ctrdx_create_worker_context"] = wasmExports["ctrdx_create_worker_context"])(a0, a1);

var _ctrdx_resize_canvas = Module["_ctrdx_resize_canvas"] = (a0, a1) => (_ctrdx_resize_canvas = Module["_ctrdx_resize_canvas"] = wasmExports["ctrdx_resize_canvas"])(a0, a1);

var _ctrdx_context_lost = Module["_ctrdx_context_lost"] = () => (_ctrdx_context_lost = Module["_ctrdx_context_lost"] = wasmExports["ctrdx_context_lost"])();

var _ctrdx_event_buffer = Module["_ctrdx_event_buffer"] = a0 => (_ctrdx_event_buffer = Module["_ctrdx_event_buffer"] = wasmExports["ctrdx_event_buffer"])(a0);
